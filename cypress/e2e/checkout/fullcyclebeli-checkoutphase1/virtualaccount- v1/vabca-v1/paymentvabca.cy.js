...
describe('Should Success When Checkout Payment with VA BCA', () => {
  const checkoutPayment = () => {
    ...
    // cy.screenshot('vabca-selesaikanpembayaran');
    cy.get('div')
    ...
    cy.get('[class="css-901oao r-ba7s3 r-1inkyih r-16dba41 r-3ucsff r-7ptqe7 r-ku1wi2 r-1joea0r"]')
      .should('be.visible')
    // Cypress.Screenshot.defaults({ capture: 'runner' });
    // cy.screenshot('vabca-orderdetail');
  };
...
//END POSITIVE CASE : Should Success When Checkout Payment with VA BCA
